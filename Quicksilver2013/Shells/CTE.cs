...
namespace Quicksilver2013.Shells
{
    class CTE : Shell
    {
        ...
        public string text;
        public ATS textScreen = new ATS();
        public Cosmos.Hardware.Keyboard keyboard = new Cosmos.Hardware.Keyboard();
    ...
    public class ATS : Cosmos.Hardware.Device
    {
        ...
        protected readonly Cosmos.Core.MemoryBlock08 mRAM;
        ...
        {
            IO.Memory.MoveUp(0, mRow2Addr, mScrollSize);
            IO.Memory.Fill(mScrollSize, mRowSize32, mClearCellValue32);
        }
        public void put(int aX, int aY, char c)
        {
            this[aX, aY] = c;
        }
    ...
    public class Keyboard : Cosmos.Hardware.Device {
        protected Cosmos.Core.IOGroup.Keyboard IO = Cosmos.Core.Global.BaseIOGroups.Keyboard;
        ...
        public Keyboard() {
            ...
            Cosmos.Core.INTs.SetIrqHandler(0x01, HandleIRQ);
